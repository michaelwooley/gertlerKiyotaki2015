...
sVg = gradient(subs(Fk,kHt,kHtp1),[Qtp1,kHtp1,Dtp1,Rtp1]);
...
%   Numerator
matlabFunction(Kknc','File','KcGt2Lt1','Vars',vOut);
%   Denominator
matlabFunction(Kkdc','File','KdcGt2Lt1','Vars',vOut);

% Full Kk 
matlabFunction(Kk,'File','KkGt2Lt1','Optimize',false);

% State Vector
vOutS = {[Qtp1,kHtp1,Dtp1,Rtp1],kHt,Qrun};
matlabFunction(stateV,'File','SvGt2Lt1','Vars',vOutS);

% State Vector Jacobian
matlabFunction(sVj,'File','SvJLt','Optimize',false,'Vars',vOut);
