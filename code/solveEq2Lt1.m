...
% Solve H - Equilibrium conditions
[Qk,Rk] = solve(Hs([1,2]),[Qt,Rt]);
...
Fk(3) = Dk;
Fk(4) = Rk;
stateV(Qtp1,kHtp1,Dtp1,Rtp1,kHt,Qrun) = Fk;
...
Fk(8) = cHk; 
Fk(9) = (1-sig)*Wb; % Cb2
eqn(Qtp1,kHtp1,Dtp1,Rtp1,kHt,Qrun) = Fk;
...
%   Numerator
matlabFunction(Kknc','File','KcEq2Lt1','Vars',vOut);
%   Denominator
matlabFunction(Kkdc','File','KdcEq2Lt1','Vars',vOut);

% Full Kk 
matlabFunction(Kk,'File','KkEq2Lt1','Optimize',false);

% stateV
vOutS = {[Qtp1,kHtp1,Dtp1,Rtp1],kHt,Qrun};
matlabFunction(stateV,'file','SvEq2Lt1','Vars',vOutS);

% eqn
matlabFunction(eqn,'file','eqnEq2Lt1','Vars',vOutS,'Optimize',false);
