function [ s,flag,gtlt ] = objEq2Gt1( sp,Qrun,t,options,re )
%objEq2Gt1 - Objective function. Case t = 2, x > 1
%   [ s,flag,gtlt ] = objEq2Gt1( sp,Qrun,t,options,re )

% Set up objective function
problem.objective = @(k) KkEq2Gt1(sp(3),sp(1),k,sp(2));
...
s = SvEq2Gt1(sp(3),Qrun,sp(1),cand,sp(2));

% Check to see if it is a valid solution
[~,c] = NlConEq2Gt1(sp(3),Qrun,sp(1),cand,sp(2));
